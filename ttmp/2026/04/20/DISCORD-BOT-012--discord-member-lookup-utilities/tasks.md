...
- [x] Add `ctx.discord.members.fetch(guildID, userID)`
- [x] Add `ctx.discord.members.list(guildID, payload?)`
- [x] Add normalized member snapshot guidance for fetch/list results
- [x] Add runtime tests for member lookup helpers
- [x] Update the moderation example bot with member lookup commands
